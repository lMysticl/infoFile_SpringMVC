package com.putrenkov.springmvc.controller;
...
import com.putrenkov.springmvc.util.CalculatingStatistics;
import com.putrenkov.springmvc.util.FileHelper;
import com.putrenkov.springmvc.util.FileValidator;
...
public class AppController {
    ...
    @RequestMapping(value = {"/get-filtered-files"}, method = RequestMethod.TRACE, produces = { "text/html; charset=UTF-8;" })
    public String getFilteredFiles(@RequestParam String condition, ModelMap model) {
