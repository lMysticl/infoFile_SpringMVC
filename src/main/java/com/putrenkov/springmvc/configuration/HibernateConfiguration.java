package com.putrenkov.springmvc.configuration;
...
@ComponentScan("com.putrenkov.springmvc")
...
public class HibernateConfiguration {
    ...
    private static final String PACKAGES_TO_SCAN = "com.putrenkov.springmvc.model";
